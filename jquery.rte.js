/*
* jQuery RTE plugin 0.5.3 - create a rich text form for Mozilla, Opera, Safari and Internet Explorer
*
* Copyright (c) 2020 Batiste Bieler
...
if(typeof $.fn.rte === "undefined") {
    ...
    return this.each( function() {
        ...
        function enableDesignMode() {
            ...
            var doc = "<html><head>" +css + "</head><body id='frameBody'>" +content + "</body></html>";
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-" + element_id + "'><div>\
                ...
                <p>\
                    ...
                    <a href='#' title='insert image' class='image'><i class='fa fa-file-image-o' aria-hidden='true'></i></a>\
